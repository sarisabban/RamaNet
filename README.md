...
`sudo apt update && sudo apt full-upgrade && sudo apt install dssp gnuplot python3-pip python3-biopython python3-pandas python3-numpy python3-matplotlib python3-bs4 python3-lxml python3-scipy python3-tensorflow python3-tqdm && pip3 install keras`
