...
`sudo apt update && sudo apt full-upgrade && sudo apt install python3-pip DSSP gnuplot && sudo pip3 install biopython bs4 tqdm pandas numpy keras matplotlib tensorflow scipy `
